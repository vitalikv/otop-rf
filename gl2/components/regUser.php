...
function sendMess($inf)
{
	...
	$mess = 'Здравствуйте, вы зарегистрировались на сайте отопление-дома-своими-руками.рф (отопление 3D). Чтобы закончить регистрацию, пройдите по <a href="'.$url.'/active_2/'.$inf['token'].'">ссылке</a>.<br><br>';
