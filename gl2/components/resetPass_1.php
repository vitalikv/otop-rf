...
function sendMess($inf)
{
	...
	$mess = 'Здравствуйте, вы забыли пароль на сайте отопление-дома-своими-руками.рф (отопление 3D). Чтобы обновить пароль, пройдите по <a href="'.$url.'/reset_pass_2/'.$inf['token'].'">ссылке</a>.<br><br>';
